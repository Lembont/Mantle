...
namespace MantleEnemy
{
    ...
    public class Plugin : BaseUnityPlugin {
        ...
        private void Awake() {
            ...
            var MantleEnemy = ModAssets.LoadAsset<EnemyType>("MantleEnemy");
            var MantleEnemyTN = ModAssets.LoadAsset<TerminalNode>("MantleEnemyTN");
            var MantleEnemyTK = ModAssets.LoadAsset<TerminalKeyword>("MantleEnemyTK");
            ...
            */
            ...
            NetworkPrefabs.RegisterNetworkPrefab(MantleEnemy.enemyPrefab);
            ...
            Enemies.RegisterEnemy(MantleEnemy, BoundConfig.SpawnWeight.Value, Levels.LevelTypes.All, MantleEnemyTN, MantleEnemyTK);
